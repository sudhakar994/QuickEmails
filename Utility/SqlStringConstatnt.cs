...
namespace QuickEmail.Utility
{
    public static class SqlStringConstant
    {
        ...
        public const string GetContactDetails = "SELECT Contact_Id ContactId,User_Id UserId, Contact_Name ContactName,Email ContactEmail, Phone ContactPhone,Country Country, User_Domain UserDomain FROM em_Contacts WHERE User_Id=@UserId AND Is_Deleted=0";
    }
}
